...
migrations:
	...
	sudo docker-compose run youtubeweb python manage.py makemigrations importdata

migrate:
	# Migrate migrations from importdata on database
	sudo docker-compose run youtubeweb python manage.py migrate importdata

fixture:
	# Generate fixtures saved upon importdata models
	sudo docker-compose run youtubeweb python manage.py dumpdata importdata --format json > YoutubeService/importdata/fixtures/data.json
